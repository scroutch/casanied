...
?>
    <div class="card m-2">
        ...
        <div class="card-body d-flex flex-column justify-content-around">
            ...
            <p class="card-text d-flex justify-content-center"><i class="fa-solid fa-location-dot"></i><span class="ps-2"><?php echo $data['lieu'] ?></span></p>
            <p class="card-text d-flex justify-content-around">
                ...
                <span class="p-2"><i class="fa-solid fa-arrows-up-down-left-right"></i><span class="ps-2"><?php echo $data['surface'] ?></span></span>
            </p>
        </div>
